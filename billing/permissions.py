...
class CanManageInvoices(BasePermission):
    """business/permissions-matrix.md: invoices created by receptionist/cashier/admin; cashier updates until paid."""
    ...
    def has_permission(self, request, view):
        ...
        if request.method in SAFE_METHODS:
            return in_role(user, "secretary", "accountant", "clinic_admin", "doctor", "patient")
        return in_role(user, "secretary", "accountant", "clinic_admin")
